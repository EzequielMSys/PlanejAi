  ...
  return (
    ...
    >
      <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-full w-full">
        ...
        <path d="M24 17.4v20.1M16 20.5c2.45-.17 4.45.43 6 1.8M32 20.5c-2.45-.17-4.45.43-6 1.8M16 25c2.45-.17 4.45.43 6 1.8M32 25c-2.45-.17-4.45.43-6 1.8" stroke="#6157D9" strokeWidth="1.8" strokeLinecap="round" />
        <path d="m36.5 8 .95 2.55L40 11.5l-2.55.95L36.5 15l-.95-2.55L33 11.5l2.55-.95L36.5 8Z" fill="#E9D5FF" />
        <defs>
          <linearGradient id="brand-gradient" x1="5" y1="4" x2="43" y2="45" gradientUnits="userSpaceOnUse">
            <stop stopColor="#8477F7" />
            <stop offset="1" stopColor="#4B43B7" />
          </linearGradient>
        </defs>
      </svg>
    </motion.div>
